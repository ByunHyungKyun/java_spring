...
@ControllerAdvice
public class ExcetionControllerAdvice {
	
	private static final Logger Logger = LoggerFactory.getLogger(ExcetionControllerAdvice.class);
	...
	public void ExceptionPage(Exception e,HttpServletRequest request,HttpServletResponse response)throws Exception{
		...
		out.println("<script>");
		out.println("alert('서버 장애가 발생했습니다.\\n관리자에게 연락 바랍니다.');");
