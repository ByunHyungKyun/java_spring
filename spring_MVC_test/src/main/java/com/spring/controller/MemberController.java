...
public class MemberController {
	...
	@RequestMapping(value="/getPictureById/{id}",produces="text/plain;charset=utf-8",method=RequestMethod.GET)
	@ResponseBody
	...
	public ModelAndView mailPost(@ModelAttribute("mailRequest")MailRequestCommand mail,
		...
		String uploadPath=request.getSession().getServletContext().getRealPath("resource/mail_attach");
