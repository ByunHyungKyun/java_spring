...
public class BoardController {
	...
	public String regist(BoardRegistCommand reqReq,HttpServletRequest request)throws Exception {
		String url="board/regist_success";
		
		BoardVO board = reqReq.toBoardVO();
	...
	public String modifyPost(BoardModifyCommand reqReq,HttpServletRequest request)throws Exception {
