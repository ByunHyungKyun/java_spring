...
<script>
		window.onload=function(){
			...
			$('#addFileBtn').on('click',function(evnet){
			...
			$('div.fileInput').on('click','div.inputRow > button',function(evnet){
				$(this).parent('div.inputRow').remove();
				
			});
			
			$('fileInput').on('change','input[type="file"]',function(evnet){
				if(this.file[0].size>1024*1024*40){
