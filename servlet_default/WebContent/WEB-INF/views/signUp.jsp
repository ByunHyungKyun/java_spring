...
<section class="content">
  ...
  <div class="register-logo">
    <a href="../../index2.html"><b>Princebyun</b>&nbsp 회원가입</a>
  </div>

  <div class="card">
    <div class="card-body register-card-body">
      <p class="login-box-msg">Register a new membership</p>
      <form action="${pageContext.request.contextPath}/hwSignUp" method="post">
          ...
          <div class="col-8">
            <div class="icheck-primary">
              <label for="agreeTerms">
               ...
               <input type="submit" value="회원가입 완료" class="btn btn-success float-right">
              </label>
            </div>
          </div>
          <!-- /.col -->
    ...
    <!-- /.form-box -->
      ...
      <div class="col-md-3"></div>
        <div class="col-6">
          <a href="${pageContext.request.contextPath}/hwList" class="btn btn-secondary">회원 리스트 돌아가기</a>
          <!-- <input type="submit" value="회원가입 완료" class="btn btn-success float-right"> -->
        </div>
        <div class="col-md-3"></div>
      </div>
