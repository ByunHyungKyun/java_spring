...
public class NoticeController {
	...
	public String regist(NoticeRegistCommand reqReq,HttpServletRequest request)throws Exception {
		String url="notice/regist_success";
		
		NoticeVO notice = reqReq.toNoticeVO();
	...
	public String modifyPost(NoticeModifyCommand reqReq,HttpServletRequest request)throws Exception {
